    ...
    <script>
        $(document).ready(function(){
            $("#submit").click(function(){
                ...
                $.post("/coffee/index.php/Home/Login/login",d,function(data){
                    if(data == "OK")
                    {
            ...
            $("#Search").click(function(){
              ...
              $.post("/coffee/index.php/Home/Index/search",{"text":text},function(data){
                  var json = eval('(' + data + ')'); 
                  var dat = "";
                  for(var i in json)
                  {
                    dat += "<div style=\"float: left; border: solid red 1px; height:230px;width:24%; margin-right: 1%;margin-top: 2%;\"><div style=\"height: 70%; border: solid red 1px;\"><a href=\"/coffee/index.php/Home/Index/goods?id="+json[i]['id']+"\" target=\"_blank\"><img src=\"/coffee/Public/img/"+json[i]['pic']+"\" style=\"height: 100%; width: 100%;\"></a></div><div style=\"margin-top: 4%;\"><div style=\"font-size: 20px;font-weight: 700;margin-left: 5%;\">"+json[i]['goodsname']+"</div><div style=\"font-size: 20px;font-weight: 700; margin-left: 80%;color:#f76120\">"+json[i]['price']+"$</div></div></div>";
                  }
                  $("#goods").html(dat);
              });
            });
            $(".sort").click(function(){
              ...
              var text = $("#SearchContent").val();
              $.post("/coffee/index.php/Home/Index/sort",{"text":text,"sort":sort,"left":left,"right":right},function(data){
                  var json = eval('(' + data + ')'); 
                  var dat = "";
                  for(var i in json)
                  {
        ...
        <div class="row" style="background-color: #c40000;">
            ...
            <div class="col-md-offset-9">
                <ul class="nav nav-pills" style="margin-top: 1%;">
                  ...
                  <li role="presentation"><button class="btn btn-lg" style="background-color: #c40000; font-size: 20px;"><a style="text-decoration: none; color:white;" href="/coffee/index.php/Home/Login/index" target="_blank">Register</a></button></li>
                  <?php else: ?><li role="presentation"><button class="btn btn-lg" style="background-color: #c40000; font-size: 20px;"><a style="text-decoration: none; color:white;" href="/coffee/index.php/Home/Person/index?id=<?php echo ($id); ?>"><?php echo ($name); ?></a></button></li>
                  <li role="presentation"><button class="btn btn-lg" style="background-color: #c40000; font-size: 20px;"><a style="text-decoration: none; color:white;" href="/coffee/index.php/Home/Login/logout">Logout</a></button></li><?php endif; ?>
                </ul>
            </div>
        </div>
            ...
            <div id="carousel-example-generic" class="carousel slide col-md-offset-1 col-md-10" data-ride="carousel">
              ...
              <div class="carousel-inner" style="height: 500px;" role="listbox">
                <div class="item active">
                  <img src="/coffee/Public/img/slide1.png" alt="..." style="height: 100%;width: 100%;">
                </div>
                <div class="item">
                  <img src="/coffee/Public/img/slide2.png" alt="..." style="height: 100%;width: 100%;">
                </div>
                <div class="item">
                  <img src="/coffee/Public/img/slide3.png" alt="..." style="height: 100%;width: 100%;">
                </div>
              </div>
            </div>
        </div>
            ...
            <div class="col-md-offset-1 col-md-10" id="goods">
                <?php if(is_array($li)): $i = 0; $__LIST__ = $li;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$li): $mod = ($i % 2 );++$i;?><div style="float: left; border: solid red 1px; height:230px;width:24%; margin-right: 1%;margin-top: 2%;">
                    <div style="height: 70%; border: solid red 1px;">
                        <a href="/coffee/index.php/Home/Index/goods?id=<?php echo ($li['id']); ?>" target="_blank"><img src="/coffee/Public/img/<?php echo ($li['pic']); ?>" style="height: 100%; width: 100%;"></a>
                    </div>
