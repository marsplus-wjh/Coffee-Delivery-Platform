        ...
        $(document).ready(function(){
            $("#submit").click(function(){
                ...
                $.post("/coffee/index.php/Home/Login/login",d,function(data){
                    if(data == "OK")
                    {
                        window.location.href = "/coffee/index.php/Home/Index/goods?id="+$("#gid").val();
                    }
                    else 
                    {
            ...
            $("#submitbooking").click(function(){
                ...
                if(name == "" || phone == "")
                    return;
                $.post("/coffee/index.php/Home/Index/booking",{"uid":uid,"gid":gid,"candy":candy,"cold":cold,"name":name,"add":add,"phone":phone,"num":num},function(data){
                    if(data == "OK")
                    {
                        window.location.href="/coffee/index.php/Home/Person/index?id="+uid;
                    }
                });
            });
    ...
    <div class="container">
        ...
        <div class="row" style="margin-top: 5%;">
            <div class="col-md-offset-1 col-md-5" style="height: 400px;">
                <img src="/coffee/Public/img/<?php echo ($li['pic']); ?>" style="height:100%; width: 100%;">
            </div>
            <div class="col-md-4">
                <form>
