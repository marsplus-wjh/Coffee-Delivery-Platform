...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-sm-offset-3 col-sm-6" style="margin-top: 1%; background-color: #FFFFFF; height: 500px; border: #CCC solid 1px; box-shadow: 2px 2px 10px #c0c0c0;" >
            ...
            <table class="table">
                <tr><th>BookingNumber</th><th>Class</th><th>Status</th><th>Time</th></tr>
                <?php if(is_array($li)): $i = 0; $__LIST__ = $li;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$li): $mod = ($i % 2 );++$i;?><tr>
                    <td><a href="/coffee/index.php/Admin/Index/show_booking?id=<?php echo ($li["id"]); ?>" style="text-decoration: none;"><?php echo ($li["id"]); ?></a>
                    </td>
                        <td><a href="/coffee/index.php/Admin/Index/show_booking?id=<?php echo ($li["id"]); ?>" style="text-decoration: none;"><?php echo ($li["add"]); ?></a>
                        </td>
                    <td>
